...
import com.tech.eagleeyebookshop.models.AccCard;
import com.tech.eagleeyebookshop.models.CardDetails;
...
public class CustomerAccountCard extends AppCompatActivity {
    ...
    class MyAdapter extends ArrayAdapter<CardDetails> {
        ...
        public View getView(int position, View view, ViewGroup parent) {
            ...
            holder.COL4.setText("CCV:- "+user.get(position).getCsv());
                    ...
                    buttonupdate.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            if (Ownername.isEmpty()) {
                                ...
                                editText4.setError("CCV is required");
